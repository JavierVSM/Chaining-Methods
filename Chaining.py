...
carlos.make_deposit(100).make_deposit(200).make_deposit(200).display_user_balance()

print ("=== Have the second user make 2 deposits and 2 withdrawals and then display their balance ===")
edgar.make_deposit(100).make_withdrawal(200).make_deposit(300).make_withdrawal(200).display_user_balance()

print ("=== Have the third user make 1 deposits and 3 withdrawals and then display their balance ===")
laura.make_deposit(1000).make_withdrawal(200).make_withdrawal(100).make_withdrawal(300).display_user_balance()
